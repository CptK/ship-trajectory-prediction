...
class TrajectoryTrainer:
    ...
    def __init__(
        ...
        self.device = device or (
            ...
            else torch.device("mps") if torch.cuda.is_available()
    ...
    def compute_loss(
        ...
        mask_positions = (masked_input == self.train_loader.dataset.mask_token)
    ...
    def train(
        ...
        for epoch in range(start_epoch, max_epochs):
            ...
            is_best = (
                (self.minimize_metric and current_value < self.best_value) or
